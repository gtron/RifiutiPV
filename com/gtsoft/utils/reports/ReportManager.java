...
public class ReportManager {
    ...
    public static void printPageNumber( int numDa, int num ) {
        ...
        try {
            ...
            String rep = "primapassata.jasper" ;
    ...
    public static void printSumMovimenti( Vector list ) {
        ...
        try {
            ...
            String rep = "SinteticoRifiuti.jasper" ;
    ...
    public static void printMovimentiTrasportatore( Vector list ) {
        ...
        try {
            ...
            String rep = "MovimentiTrasportatore.jasper" ;
    ...
    public static void printCover( ) {
        ...
        try {
            ...
            String rep = "copertina_registro.jasper" ;
    ...
    private static void stampaMovimenti( Vector list, String filename ) throws Exception {
        ...
        String rep = "stampa_movimenti.jasper" ;
        String repExp = "stampa_movimenti_xls.jasper";
        ...
        if ( list != null && list.size() > 0 ) {
            ...
            if ( vett != null ){
                map.put("Trasportatore", vett.getRagioneSociale() );
                rep = "movimenti_trasportatore.jasper" ;
                repExp = "movimenti_trasportatore_xls.jasper";
                ...
                */
            	...
            	if ( rifiuto != null && ! RifiutiFrame.isRifiuto342 ){
                    ...
                    rep = "movimenti_rifiutounico.jasper" ;
                    repExp = "movimenti_rifiutounico_xls.jasper";
    ...
    private static void stampaRifiuti( Vector list, String filename,  boolean ignoreSingoloTrasportatore ) throws Exception {
        ...
        String rep = "stampa_rifiuti.jasper" ;
        String repExp = "stampa_rifiuti_xls.jasper";
        ...
        if ( list != null && list.size() > 0 ) {
            ...
            if ( vett != null)
                ...
                if ( rif != null && ! RifiutiFrame.isRifiuto342 ) {
                    map.put("Rifiuto", rif );
                    rep = "sintetico_rifiutounico.jasper" ;
                    repExp = rep ;
