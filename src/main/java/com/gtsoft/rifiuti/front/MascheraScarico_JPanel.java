...
public class MascheraScarico_JPanel extends JPanel {
    ...
    private int calcolo_giacenza() {
        ...
        for(int row=0;row<getJTable().getMyTableModel().getRowCount();row++) {
            ...
            giacenza=giacenza+Integer.valueOf(value);
        }
        return giacenza ;
    }
...
//                }
                ...
                int target = Integer.valueOf( getTarget_jTextField().getText() );
                int i=0;
    ...
    public void refresh_giacenza() {
        ...
        int rimanenza= Integer.valueOf(getTarget_jTextField().getText()) - giacenza_selezionata;                          
        ...
        try { 
            ...
            if ( giac != null && giac.length() > 0 ) {
		        int giacenzaRifiuto = Integer.valueOf( giac.replaceAll("\\.", "") );
